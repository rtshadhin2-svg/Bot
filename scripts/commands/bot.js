...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "YES I'M AFIF ABRAR ORNAB BOT ",
          "কি গো সোনা 🥰",
          "hmmm bolo prio",
          "জি কিভাবে সাহায্য করতে পারি ",
          "Hm bolo 😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          " YES IM AFIF ABRAR ORNAB BOT ANY Help? 🙄",
          "AFIF ABRAR ORNAB OWNER",
          "হ্যা বন্ধু বলো কি করতে পারি তোমার জন্য আমি বট আমাকে কমান্ড করতে হবে "
        ];
